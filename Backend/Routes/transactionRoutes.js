...
router.get("/export/xlsx", authMiddleware, exportTransactionsXlsx);     // Download transactions as an Excel attachment
...
router.get("/insights", authMiddleware, getSpendingInsights);           // Spending insights (MoM change, top category, avg daily)
...
router.get("/tags", authMiddleware, getUserTags);                       // Get distinct tags used by the user

        ...
        <div className="max-w-5xl mx-auto p-6 md:p-8">
          ...
          {loading && (
            <div className="flex flex-col items-center justify-center py-20">
              ...
              <p className="text-slate-500 dark:text-slate-400 font-medium">Loading recurring rules...</p>
            </div>
          )}
          ...
          {!loading && rules.length === 0 && (
            <div className="bg-white dark:bg-slate-900 rounded-2xl p-12 text-center border border-slate-200 dark:border-slate-700 shadow-sm">
              ...
              <h3 className="text-lg font-semibold text-slate-700 dark:text-slate-200">No recurring transactions yet</h3>
              <p className="text-slate-500 dark:text-slate-400 mt-2">Add a rule to automatically record rent, subscriptions, or salary.</p>
            </div>
          )}
                      ...
                      <div className="flex items-start gap-4">
                        <div
                          className={`p-3 rounded-full shrink-0 ${
                            isCredit ? "bg-emerald-100 dark:bg-emerald-950 text-emerald-600 dark:text-emerald-400" : "bg-red-100 dark:bg-red-950 text-red-600 dark:text-red-400"
                          }`}
                        >
                        ...
                        <div>
                          <h4 className="font-semibold text-slate-800 dark:text-slate-100 text-base">{rule.category || "General"}</h4>
                          <div className="flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400 mt-1 flex-wrap">
                            ...
                            {!rule.active && (
                              <span className="px-2 py-0.5 rounded bg-amber-100 dark:bg-amber-950 text-amber-700 dark:text-amber-300 text-xs font-medium">
                                Paused
                              </span>
                            )}
                          </div>
